...
public class GCMIntentService extends GCMBaseIntentService {
    ...
    private void generateNotification(Context context, String message, String ids, String title) {
        ...
        */
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(this).setSmallIcon(R.drawable.ic_launcher).setContentTitle(title).setContentText(message).setContentIntent(pendingIntent).setWhen(System.currentTimeMillis()).setAutoCancel(true);
