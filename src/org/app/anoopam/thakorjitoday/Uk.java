    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRegisterTask = new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                TodayUpdateHelper.updateTodayDateStatusFromServer(mContext, "uk1", "UKDate");

                if (mSettings.getString("UK1", "").equals("")) {
                    offerImagesB[0] = TodayUpdateHelper.getImageFromServer(mContext, "uk1", "UK1.jpg", "UKDate", true);
