    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRegisterTask = new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                TodayUpdateHelper.updateTodayDateStatusFromServer(mContext, "surat1", "SURATDate");

                if (mSettings.getString("SURAT1", "").equals("")) {
                    offerImagesB[0] = TodayUpdateHelper.getImageFromServer(mContext, "surat1", "SURAT1.jpg", "SURATDate", true);
